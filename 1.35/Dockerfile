...
ENV EMCC_SDK_VERSION 1.35.23
ENV EMCC_SDK_ARCH 32

WORKDIR /

RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates build-essential curl git-core cmake openjdk-7-jre-headless python \
